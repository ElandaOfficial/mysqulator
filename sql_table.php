...
namespace SQL
{
    ...
    class DatabaseTable
    {
        ...
        public static function fromClass(string $class) : DatabaseTable
        {
            return new DatabaseTable($class, SqlSerialiser::getTableDefinition($class));
        }
        ...
        public function createTableQuery(bool $onlyIfNotExists = false, bool $deferForeignKeys = false) : string
        {
            ...
            $query = "CREATE TABLE {$ignore}`{$this->definition->name}`\n"
                ."(\n"
        ...
        public function alterTableForeignKeyQuery() : string
        {
            ...
            foreach ($this->getConstraints('reference') as $reference)
            {
