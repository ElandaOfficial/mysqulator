...
namespace SQL
{
    ...
    use SQL\Constraint\Reference;
    use SQL\Constraint\Unique;
    ...
    class TableDefinition
    {
        ...
        public function __construct(public string  $name,
                                    ...
                                    #[ArrayShape(['unique'=>'SQL\Constraint\Unique[]',
                                                  'reference'=>'SQL\Constraint\Reference[]'])]
    ...
    abstract class SqlSerialiser
    {
         ...
         *  @throws ReflectionException
         */
        #[ArrayShape([Trigger::class=>'SQL\Trigger[]', Record::class=>'SQL\Record[]', Table::class=>Table::class,
                      ...
                      Constraint\Unique::class=>'SQL\Constraint\Unique[]',
                      Constraint\Reference::class=>'SQL\Constraint\Reference[]'])]
        ...
        private static function getTypeForProperty(ReflectionProperty $property) : string
        {
            ...
            throw new Exception("Unable to deduct SQL type from PHP type '{$property->getType()->getName()}', \
